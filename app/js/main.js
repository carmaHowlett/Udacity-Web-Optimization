...
var pizzaElementGenerator = function(i) {
  ...
  pizzaImage.src = "../public/images/pizza.png";
...
var resizePizzas = function(size) {
  ...
  // By working with % vs px we dont have to worry about calculating the size
  // of the window to figure out the size of the pizza needed
...
// Used tips from http://www.html5rocks.com/en/tutorials/speed/animations/
...
// Now whenever we scroll we will try and call requestAnimationFrame,
// but if one is already requested we don’t initiate another
...
// use onScroll in place of updatePositions
